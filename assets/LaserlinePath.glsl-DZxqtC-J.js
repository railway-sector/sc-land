import{J4 as be,J0 as Pe,Ju as we,H0 as f,If as w,J6 as Ve,H1 as W,GZ as r,f9 as z,wR as K,J3 as De,HU as C,fx as ee,gl as R,gR as B,Jv as xe,fZ as te,Id as ie,Hz as M,fj as m,fy as v,Jw as ne,y_ as se,c4 as o,mo as ae,gQ as Ee,h9 as ye,gk as Le,bV as re,g3 as le,gO as Se,J1 as Ce,x3 as Me,Hx as Ae,In as $e,GY as F,cS as Re,H3 as oe,H4 as ce,_ as he,p1 as Te,cJ as J,ha as U,m as c,o as j,k2 as de,k0 as pe,b_ as Oe,bU as O,lw as Ie,HI as Ue,lB as qe,Jx as ze,Hi as D,Ja as je,Jb as G,Jy as Ne,n8 as He,Jz as T,JA as We,h4 as Be,uo as Fe,h6 as Je,h7 as Ge,h8 as ke,hb as Ze,n as A,JB as Qe,cL as k}from"./index-XaGxs5V0.js";import{t as Xe}from"./VisualElement-BK-KxHhq.js";function ue(t,e){const n=t.fragment;n.include(be),t.include(Pe),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=z(6);function fe(t){const e=new K;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
