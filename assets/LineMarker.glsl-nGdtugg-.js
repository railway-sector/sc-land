import{wR as ee,Il as te,Im as ie,GW as re,GU as ae,In as se,Io as oe,GZ as o,Ie as ne,Hx as ce,Id as le,GY as _,Ip as pe,Iq as de,HB as N,GX as he,G_ as ve,G$ as ue,HU as me,H1 as fe,Ir as U,Is as j,It as ge,Iu as Se,HC as Pe,k0 as ye,H3 as we,k2 as _e,H4 as ze,_ as xe,H5 as L,H6 as E,H7 as $e,H8 as R,H9 as I,HE as be,Hb as Te,Hc as ke,Hd as Ve,Hf as k,Hg as Oe,Iv as De,Iw as B,Ix as G,Iy as We,Iz as Ce,IA as Le,m as c,o as Ie,Hh as Me,Hi as d,eW as Ae,HF as He,IB as q,ro as Fe,I4 as Ne,IC as Ue,Hl as je,bU as Y,lc as Ee,fj as Q,c4 as X,ID as Re}from"./index-XaGxs5V0.js";function Z(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),pe(a),e.include(de),a.main.add(o`
    ...
    }`),S.include(he,t),e.include(ve,t),S.include(ue),S.uniforms.add(new me("intrinsicColor",({color:p})=>p),new fe("tex",({markerTexture:p})=>p)).constants.add("texelSize","float",1/U).code.add(o`float markerAlpha(vec2 samplePos) {
samplePos += vec2(0.5, -0.5) * texelSize;
float sdf = texture(tex, samplePos).r;
float pixelDistance = sdf * vSize;
pixelDistance -= 0.5;
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),P&&(e.include(j),S.constants.add("relativeMarkerSize","float",ge/U).constants.add("relativeTipLineWidth","float",Se).code.add(o`
  ...
  `)),e.include(Pe,t),e.include(j),S.main.add(o`
    discardBySlice(vpos);
