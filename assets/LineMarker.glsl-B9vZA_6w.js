import{wQ as ee,Il as te,Im as ie,GW as re,GU as ae,In as se,Io as oe,GZ as o,Ie as ne,Hx as ce,Id as le,GY as _,Ip as pe,Iq as de,HB as N,GX as he,G_ as ve,G$ as ue,HU as me,H1 as fe,Ir as E,Is as U,It as ge,Iu as Se,HC as Pe,k0 as ye,H3 as we,k2 as _e,H4 as ze,_ as xe,H5 as L,H6 as j,H7 as $e,H8 as R,H9 as I,HE as be,Hb as Te,Hc as ke,Hd as Ve,Hf as k,Hg as Oe,Iv as De,Iw as B,Ix as G,Iy as We,Iz as Ce,IA as Le,O as c,T as Ie,Hh as Me,Hi as d,fg as Ae,HF as He,IB as q,ro as Fe,I4 as Ne,IC as Ee,Hl as Ue,cl as Y,lc as je,fF as Q,cx as X,ID as Re}from"./index-Drx6YJRG.js";function Z(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
