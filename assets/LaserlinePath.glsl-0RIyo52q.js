import{J5 as be,J1 as we,Jm as De,yj as f,ys as w,Ja as Ve,Hx as B,yk as r,dN as j,xM as ee,J4 as xe,yq as E,bg as te,bd as A,gF as H,Jn as ye,h3 as ie,yi as ne,HS as S,eY as m,bc as v,Jo as se,yu as ae,be as o,ms as re,gE as Le,rt as Ee,bh as Se,bt as le,fV as oe,gC as Ce,J2 as Me,x_ as Ae,HQ as $e,Ip as Re,yt as F,ck as Te,qv as ce,qx as he,_ as de,e_ as Oe,cb as J,q6 as q,e as c,g as z,jK as pe,e$ as ue,ba as Ie,bf as I,lB as Ue,I1 as qe,lD as je,Jp as ze,yB as V,n_ as Ne,n$ as G,Jq as We,n5 as Be,Jr as $,Js as He,wY as k,rp as Fe,uU as Je,rq as Ge,rr as ke,rs as Qe,ru as Xe,f as C,Jt as Ye,cd as Q}from"./index-C-5VHImO.js";import{t as Ke}from"./VisualElement-CDQ0ttuZ.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
